...
bot.on("text", async (msg) => {
  ...
  if (msg.text.includes("/help")) {
    bot.sendMessage(
      msg.chat.id,
      `Привет ${name}! 
      Я дружелюбный робот Нгуен, который поможет тебе, мой друг, прочитать все, что присылают тебе в смс или где угодно вьетнамские сервисы или люди, на твоем любимом русском языке. 
